...
public class MyMobileActions {
 
    private AndroidDriver driver;
 
    public MyMobileActions (AndroidDriver driver) {
        this.driver = driver;
    }
    ...
    public void myDragDrop(MobileElement e1, MobileElement e2, AndroidDriver driver) {
		TouchAction act = new TouchAction(driver);
		PointOption po = new PointOption().point(e2.getLocation().getX(),e2.getLocation().getY());
		
		act.longPress(longPressOptions().withElement(element(e1))).moveTo(po).release().perform();
